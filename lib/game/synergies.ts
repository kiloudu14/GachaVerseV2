...
export const SYNERGIES: SynergyDef[] = [
  ...
  { id:'nosanimaux',  universe:'Nos Animaux',          label:'Nos Animaux',      color:'#86efac', glow:'#22c55e', icon:'🐾',
    thresholds:[{ count:2, label:'+16% DPS Nos Animaux',dpsBonus:16,globalBonus:0 },{ count:3, label:'+35% DPS +5% global',dpsBonus:35,globalBonus:5 }] },
  { id:'spyfamily',   universe:'Spy x Family',         label:'Spy x Family',     color:'#fca5a5', glow:'#ef4444', icon:'🕵',
    thresholds:[{ count:2, label:'+18% DPS Spy x Family',dpsBonus:18,globalBonus:0 }] },
  ...
  { id: 'chainsawman', universe: 'Chainsaw Man', label: 'Chainsaw Man', color: '#f87171', glow: '#dc2626', icon: '🪚',
    thresholds: [{ count: 2, label: '+20% DPS Chainsaw Man', dpsBonus: 20, globalBonus: 0 }] },
